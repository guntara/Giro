...
class User extends CActiveRecord
{
	...
	public function getUserDept($id) {
		$proUser=EmploymentJob::model()->findAll('department= :id', array(':id'=>$id));
		foreach($proUser as $data){
			$provider=$this->findAll('employee= :id', array(':id'=>$data->employee));
			foreach($provider as $result){ $user[] = $result->email; }
		}
